    ...
    <Sheet open={open} onOpenChange={setOpen}>
      <SheetTrigger asChild>
        <button
          ...
          className="fixed bottom-[5.5rem] right-6 z-50 h-9 w-9 rounded-full bg-card/90 border border-border text-foreground shadow-lg flex items-center justify-center hover:bg-muted hover:border-primary/50 transition-all"
        >
