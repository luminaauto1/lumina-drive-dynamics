...
const AdminChatControl = lazy(() => import("./pages/admin/AdminChatControl"));
      ...
      <main>
        <Suspense fallback={<RouteFallback />}>
          <Routes>
            ...
            <Route path="/admin/chat-control" element={<ProtectedRoute section="chat_control"><AdminChatControl /></ProtectedRoute>} />
