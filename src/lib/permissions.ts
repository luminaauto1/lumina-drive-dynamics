...
export const APP_SECTIONS: AppSection[] = [
  ...
  { key: 'chat_control',  label: 'Chat Control',     description: 'WhatsApp auto-responder: stats, answer-all button, needs-you queue, learned answers', paths: ['/admin/chat-control'], home: '/admin/chat-control' },
];
