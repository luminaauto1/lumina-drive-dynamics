...
import type { Deal, DealStatus, DealCondition } from './types';
...
export const DEAL_DESK_SELECT = `
  ...
  post_deal_notes, natis_sent_at, natis_window_days,
  vehicle:vehicles(make, model, variant, year, vin, stock_number),
  application:finance_applications(first_name, last_name, full_name, id_number, phone, email)
`;
