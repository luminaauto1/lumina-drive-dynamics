...
const Index = () => {
  ...
  const stats = [
    ...
    { value: '6', label: 'Major Banks Approved' },
    { value: 'Zero', label: 'Return Record' },
    { value: '101', label: 'Point Inspection' },
  ];
        ...
        <div className="relative z-20 h-full flex flex-col items-center justify-center text-center px-6">
          ...
          >
            ...
            <Link to="/sell-your-car">
              <Button size="lg" variant="outline" className="border-primary text-foreground hover:bg-secondary">
                Sell Your Car
              </Button>
            </Link>
          </motion.div>
